    ...
    class Html {
        ...
        public function setCss($css)
        {
            foreach(array_reverse($css) as $key => $line)
            {
                $css_file = false;
                $defer = ['mobile/common'];
                $media = ['mdb.min', '_ext/fontawesome.min'];
                ...
                if($css_file !== false)
                {
                    ...
                    external_css:
                    if(in_array($line, $media))
                    {
                        $css_load = '<link media="print" onload="this.media=\'all\'" rel="stylesheet" href="' . $css_file . '" type="text/css">' . "\n\t\t";
                    }
                    else
                    {
                        if(in_array($line, $defer))
                        {
                            $css_load = '<link rel="stylesheet" rel="preload" as="style" media="screen" href="' . $css_file . '" type="text/css">' . "\n\t\t";
                        }
                        else
                        {
                            $css_load = '<link media="screen" rel="stylesheet" href="' . $css_file . '" type="text/css">' . "\n\t\t";
                        }
